			...
			<div className="contact__content">
				<div data-aos="fade-right" className="contact__content__item">
					...
					<p className="contact__p">
						Duis non magna imperdiet urna molestie scelerisque. Etiam nunc massa, eleifend sed posuere
						vitae, rutrum vitae erat. Duis non magna imperdiet urna molestie scelerisque.
					</p>
